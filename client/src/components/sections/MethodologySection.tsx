...
function MethodologyCard({ 
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      {/* Icon */}
      <div className="bg-[#2a2665]/10 w-14 h-14 rounded-full flex items-center justify-center mb-4">
...
export default function MethodologySection() {
  ...
  useEffect(() => {
    const handleLanguageChange = () => {
      console.log("Language change event detected in MethodologySection");
    ...
    <section id="methodology" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#2a2665] mb-4">
        ...
        <Tabs defaultValue="planning" className="w-full">
          <TabsList className="flex mb-8 w-full justify-center gap-2 methodology-tabs-list">
            <TabsTrigger value="planning" className="data-[state=active]:bg-[#2a2665] data-[state=active]:text-white order-1">
              <TranslatedText textKey="methodology.planning" />
            </TabsTrigger>
            <TabsTrigger value="execution" className="data-[state=active]:bg-[#2a2665] data-[state=active]:text-white order-2">
              <TranslatedText textKey="methodology.execution" />
            </TabsTrigger>
            <TabsTrigger value="evaluation" className="data-[state=active]:bg-[#2a2665] data-[state=active]:text-white order-3">
              <TranslatedText textKey="methodology.evaluation" />
            </TabsTrigger>
            <TabsTrigger value="improvement" className="data-[state=active]:bg-[#2a2665] data-[state=active]:text-white order-4">
          ...
          <TabsContent value="planning">
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-[#2a2665] mb-2 text-alignment-dynamic">
